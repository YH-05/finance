"""Tests for market.market_common.types module.
...
from market.market_common.types import (
    ExchangeConfig,
    TickerRecord,
    __all__,
)
...
class TestModuleExports:
    ...
    def test_正常系_モジュールがインポートできる(self) -> None:
        ...
        from market.market_common import types
...
class TestTickerRecord:
    ...
    def test_正常系_必須フィールドで生成できる(self) -> None:
        ...
        assert record.market == MarketExchange.SGX
    ...
    def test_正常系_必須フィールドの型が正しい(self) -> None:
        ...
        assert isinstance(record.market, MarketExchange)
