"""Pytest configuration and fixtures for market.market_common tests."""
...
from market.market_common.constants import YFINANCE_SUFFIX_MAP, MarketExchange
...
def sample_ticker_bursa() -> TickerRecord:
    ...
    return TickerRecord(
        ...
        yfinance_suffix=YFINANCE_SUFFIX_MAP[MarketExchange.BURSA],
        sector="Financial Services",
        industry="Banks - Diversified",
...
def sample_tickers() -> list[TickerRecord]:
    ...
    return [
        ...
        TickerRecord(
            ...
            yfinance_suffix=YFINANCE_SUFFIX_MAP[MarketExchange.SET],
            sector="Financial Services",
