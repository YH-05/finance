...
This module tests the returns.py implementation for Issue #469.
Tests cover:
...
# =============================================================================
# Tests for TICKERS_GLOBAL_INDICES constant
# =============================================================================


class TestTickersGlobalIndicesConstant:
    """Tests for TICKERS_GLOBAL_INDICES list constant."""
...
class TestCalculateMultiPeriodReturns:
    ...
    def test_異常系_空のSeriesで空のdictを返す(self) -> None:
        """空のSeriesで空または全てNoneのdictを返すことを確認。"""
        empty_prices = pd.Series([], dtype=float)
...
class TestFetchTopixData:
    ...
    @patch("market_analysis.analysis.returns.yf.download")
