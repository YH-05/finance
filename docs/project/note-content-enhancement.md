...
| # | タイトル | ラベル | Phase | 依存 |
|---|---------|--------|-------|------|
| 95 | マガジン運営方針ドキュメント作成 | documentation | 1 | - |
| 96 | 市場分析ガイドライン作成 | documentation | 2 | - |
| 97 | スタイルファクター用プリセット追加 | enhancement | 3 | #96 |
| 98 | SEC EDGARエージェント作成 | enhancement | 1 | #99 |
| 99 | SEC決算スキーマ作成 | enhancement | 1 (最優先) | - |
| 100 | センチメント分析エージェント作成 | enhancement | 2 | #101 |
| 101 | センチメントスキーマ作成 | enhancement | 2 (最優先) | - |
| 102 | finance-researchへのSEC/センチメント統合 | enhancement | 2 | #98,#100,#101 |
| 103 | /finance-full統合コマンド作成 | enhancement | 5 | #95,#96,#97,#98,#99,#100,#101,#102 |
