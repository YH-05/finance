...
| #50 | agents.md への登録と /index 更新 | 未完了 | - |
| #51 | エージェント使用ガイドの作成 | 完了 | `docs/image-collector-guide.md` |
| #254 | 金融ニュース収集エージェント群の機能改善 | 未完了 | [詳細](#254-金融ニュース収集エージェント群の機能改善) |
| #255 | サブエージェントごとのGitHub Issue登録機能 | 未完了 | [詳細](#255-サブエージェントごとのgithub-issue登録機能) |
| #269 | test-writerエージェントの最適化 | 未完了 | [詳細](#269-test-writerエージェントの最適化) |
...
- [ ] test-orchestrator.md を作成
- [ ] test-planner.md を作成
- [ ] test-unit-writer.md を作成
- [ ] test-property-writer.md を作成
- [ ] test-integration-writer.md を作成
- [ ] write-tests.md を更新
- [ ] 新規モジュールでテスト作成を実行し、実行時間を計測
- [ ] 従来のtest-writerとの比較検証
