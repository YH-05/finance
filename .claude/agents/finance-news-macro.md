...
[INFO] 重複チェック中...
[INFO] 重複スキップ: 円安進行、1ドル150円 → Issue #185 (URL一致)
[INFO] 重複スキップ: FRB議長発言 → Issue #180 (タイトル類似(89%))
[INFO] 新規記事: 4件
...
| Issue # | タイトル | 公開日 |
|---------|----------|--------|
| #202 | FRB、利上げを決定 | 2026-01-22 |
| #203 | 日銀、金融政策を維持 | 2026-01-22 |
| #204 | 円安進行、1ドル155円に | 2026-01-22 |

### 重複でスキップされた記事（5件）

| 記事タイトル | 重複先 | 理由 |
|-------------|--------|------|
| 円安進行、1ドル150円 | #185 | URL一致 |
| FRB議長発言 | #180 | タイトル類似(89%) |
| ...（他3件）... | | |
```
