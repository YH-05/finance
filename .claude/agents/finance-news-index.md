...
def load_session_data(session_file: str) -> dict:
    ...
    session_file : str
        ...
        例: .tmp/news-collection-20260126-143000.json

    Returns
    -------
    dict
        セッションデータ（existing_issues含む）
    """
...
#### ステップ4.0.5: 記事本文取得と要約生成【サブエージェント必須】
...
[INFO] 重複チェック中...
[INFO] 重複スキップ: NYダウ、最高値更新 → Issue #190 (URL一致)
[INFO] 重複スキップ: S&P500が最高値更新 → Issue #185 (タイトル類似(87%))
[INFO] 新規記事: 3件
...
| Issue # | タイトル | 公開日 |
|---------|----------|--------|
| #200 | 日経平均、3万円台を回復 | 2026-01-22 |
| #201 | S&P500、史上最高値を更新 | 2026-01-22 |
| #202 | ナスダック、テック株主導で上昇 | 2026-01-22 |

### 重複でスキップされた記事（5件）

| 記事タイトル | 重複先 | 理由 |
|-------------|--------|------|
| NYダウ、最高値更新 | #190 | URL一致 |
| S&P500が最高値更新 | #185 | タイトル類似(87%) |
| ...（他3件）... | | |
```
