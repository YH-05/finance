...
def register_chat_tools(mcp: FastMCP) -> None:
    ...
    @mcp.tool()
    @mcp_tool_handler("notebooklm_chat")
    ...
    @mcp.tool()
    @mcp_tool_handler("notebooklm_get_chat_history")
    ...
    @mcp.tool()
    @mcp_tool_handler("notebooklm_clear_chat_history")
    ...
    @mcp.tool()
    @mcp_tool_handler("notebooklm_configure_chat")
    ...
    @mcp.tool()
    @mcp_tool_handler("notebooklm_save_chat_to_note")
