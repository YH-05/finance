...
| [#130](https://github.com/YH-05/finance/issues/130) | T16: SizeFactor | P0 | 0.5-1h | 🔄 In Progress |
...
**最終更新**: 2026-01-17
**更新内容**: GitHub Project #13 (factor) と project.md を同期（#128 QualityFactor 完了、#130 SizeFactor 進行中）
