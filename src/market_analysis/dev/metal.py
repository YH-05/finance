...
class DollarsIndexAndMetalsAnalyzer:
    ...
    def __init__(self):
        ...
        """
        self.fred_db_path = self._load_fred_db_path()
    ...
    # -------------------------------------------------------------------------------------
    def _load_fred_db_path(self):
        load_dotenv()
        return Path(os.environ.get(key="FRED_DIR")) / "FRED.db"
    ...
    def load_price(self):
        ...
        """
        conn = sqlite3.connect(self.fred_db_path)
        df_dollars = (
